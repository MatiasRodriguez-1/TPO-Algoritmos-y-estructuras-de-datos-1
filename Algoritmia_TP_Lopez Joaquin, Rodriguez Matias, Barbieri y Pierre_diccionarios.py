...
def registrarUsuario():
    ...
    while not nombre_valido:
        ...
        existe_nombre = any(u["usuario"] == usuario for u in usuarios)
        if existe_nombre:
            print("Ese nombre de usuario ya existe. Elegi otro.")
        else:
            nombre_valido = True

    # Reglas de contraseña (formato solamente)
    print("La contraseña debe tener al menos 8 caracteres, una mayuscula y un numero.")
